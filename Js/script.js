        ...
        alternativas: [
            {
                ...
                "Além disso, a busca ativa de faltosos e a atualização constante da caderneta vacinal são indispensáveis para manter altas taxas de cobertura e evitar o reaparecimento de doenças erradicadas."]
            },
            {
                ...
                afirmacao: ["Profissional da área da saúde ou estudante de epidemiologia.",
                    "Dessa forma, a alocação de recursos em ações preventivas gera maior eficiência orçamentária no médio e longo prazo, liberando verbas para outras demandas da rede pública."]
            }    
            ...
            alternativas: [
                {
                    ...
                    afirmacao: ["Você demonstra um perfil  de pesquisador e inovador que busca por meio da inovação soluções para o meio ambiente e sustentabilidade das gerações posteriores.",
                        "A identificação detalhada dos depósitos de água e o mapeamento dos índices de infestação predial orientam o direcionamento pontual das ações de bloqueio químico na rotina de campo."]
                },
                {
                    ...
                    afirmacao: ["Agente de Combate a Endemias ou profissional de vigilância ambiental",
                        "Promover parcerias entre as escolas, associações de bairro e serviços de limpeza urbana fortalece a corresponsabilidade social na manutenção dos ambientes comunitários."]
                }    
            ...
            alternativas: [
                {
                    ...
                    afirmacao: ["A APS estabelece vínculo continuado entre a equipe de saúde e o usuário, permitindo o acompanhamento do histórico do paciente e facilitando o diagnóstico precoce.",
                        "Essa longitudinalidade do cuidado garante escuta qualificada nas consultas e permite construir planos terapêuticos individualizados que respeitam o contexto do paciente."]
                },
                {
                    ...
                    afirmacao: ["Sanitarista ou planejador de redes de atenção à saúde",
                        "A regulação eficiente do acesso aos serviços especializados e de média complexidade garante a sustentabilidade financeira e a racionalização da capacidade instalada do SUS."]
                }    
            ]
        }
    ]
